...
W_REF = 1000
Q_FRAMES = int(120.0 / (DT * DEC))  # ~258 chroma frames = 60 s of voiced melody
POSITIONS = (0.05, 0.5)            # where user might hit record (post-opening)
...
print(f'H: 120s-query Qmax: top1={t1}/{n_eval}={t1/n_eval:.1%} top5={t5}/{n_eval}={t5/n_eval:.1%}', flush=True)
